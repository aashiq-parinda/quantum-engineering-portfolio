...
| :---: | :--- | :--- | :---: | :--- |
| **Research** | **GenAI × Quantum (Original)** | [`quantum-genai-warmstart`](https://github.com/aashiq-parinda/quantum-genai-warmstart) | ✅ `14/14 tests` | **Original research**: 12K-param pure-NumPy transformer predicting VQE warm-start parameters. **Zenodo Published (DOI: [10.5281/zenodo.21979940](https://doi.org/10.5281/zenodo.21979940))**. |
| **Research** | **ZNE Paper Reproduction** | [`quantum-zne-reproduction`](https://github.com/aashiq-parinda/quantum-zne-reproduction) | ✅ `21/21 tests` | **Full reproduction of Temme et al. 2017** (PRL 119, 180509): Gate folding, Richardson extrapolation, Figures 1–3 reproduced, discrepancy analysis documenting overshoot at $\lambda \geq 0.05$. |
