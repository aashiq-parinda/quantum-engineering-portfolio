...
| :---: | :--- | :--- | :---: | :--- |
| **Research** | **GenAI × Quantum (Original)** | [`quantum-genai-warmstart`](https://github.com/aashiq-parinda/quantum-genai-warmstart) | ✅ `14/14 tests` | **Original research**: 12K-param pure-NumPy transformer predicting VQE warm-start parameters from Pauli token embeddings. Falsifiable hypothesis, self-disproof attempts, preprint draft, literature review. |
